...
public class CorsConfig implements WebMvcConfigurer {
    ...
    public void addCorsMappings(CorsRegistry registry){
        registry.addMapping("/**") //Esto es para que aplique a todas las rutas de la API
                .allowedOrigins("https://cars-ecommerce-frontend-git-develop-javizzzs-projects.vercel.app/", "http://localhost:4200/", "https://cars-ecommerce-frontend.vercel.app/") // Para elegir los dominios que pueden consumir
